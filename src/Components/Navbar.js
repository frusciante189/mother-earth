...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 inset-x-0 z-50 bg-primary">
      <div className="container mx-auto py-4">
        <div className="lg:flex lg:justify-between lg:items-center max-w-7xl mx-auto">
          ...
          >
            <div className="flex space-x-4 items-center">
              <a href="/" className="p-3 rounded-full bg-white">
                <svg
                  ...
                  stroke-width="0"
                  viewBox="0 0 448 512"
                  className="text-primaryText w-4 h-4"
                  height="1em"
                  width="1em"
              ...
              <a href="/" className="p-3 rounded-full bg-white">
                <svg
                  ...
                  stroke-width="0"
                  viewBox="0 0 448 512"
                  class="text-primaryText w-4 h-4"
                  height="1em"
                  width="1em"
                  xmlns="http://www.w3.org/2000/svg"
                >
              ...
              <a href="/" className="p-1.5 rounded-full lg:hidden flex">
                <img
            ...
            <div className="p-0.5 ml-4 hidden lg:block">
              <button className="text-white px-5 py-2 rounded-lg bg-gradient-to-l from-[#00655b] to-[#00a231]  shadow-lg uppercase">
                Join our Discord
              </button>
            </div>
          </div>
