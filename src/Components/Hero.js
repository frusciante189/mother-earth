...
const Hero = () => {
  ...
  return (
    <div className="h-99 relative ">
      ...
      <div className="text-white flex flex-col items-center justify-center pt-20 absolute lg:bottom-10 bottom-3 left-1/2 ml-4 -translate-x-1/2  max-w-[500px] mx-auto">
